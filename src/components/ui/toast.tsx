  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      [
        ...
        "group-[.success]:border-green-300 group-[.success]:hover:bg-green-100",
        "group-[.warning]:border-yellow-300 group-[.warning]:hover:bg-yellow-100",
        "group-[.info]:border-blue-300 group-[.info]:hover:bg-blue-100"
      ],
      className
    )}
    {...props}
  ...
  <ToastPrimitives.Close
    ...
    className={cn(
      [
        ...
        "group-[.success]:text-green-600 group-[.success]:hover:text-green-900",
        "group-[.warning]:text-yellow-600 group-[.warning]:hover:text-yellow-900",
        "group-[.info]:text-blue-600 group-[.info]:hover:text-blue-900"
      ],
      className
    )}
